...
namespace Application.Services
{
    public class SubscriptionTransformService : ISubscriptionTransformService
    {
        ...
        public async Task<IEnumerable<SubscriptionDTO>?> GetSubscriptionDTOsAsync(IEnumerable<Subscription>? subs, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<SubscriptionDTO?> GetSubscriptionDTOAsync(Subscription? sub, CancellationToken cancellationToken = default)
        {
